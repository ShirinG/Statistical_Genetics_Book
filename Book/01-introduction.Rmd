...
Statistical Genetics describes the scientific field that uses statistics to gain insight from genetic data.

This book will start with evolutionary and population genetics, the subfield that studies evolutionary processes like speciation and adaptation or population-level phenomena like migration, drift, etc.
