...
Evolutionary and population genetics are interested in the genetics of population-scale processes, like speciation and adaptation. The basis for population-level genetics are genes and alleles, which are passed on from generation to generation (and in some cases horizontally within generations). Alleles change in frequency over time and with different environments and thus directly contribute to adaptation. In sum, population structure is influenced by the combined effects of all alleles in a population and their dominance effects, epistasis and epigenetic regulations.

In order for adaption to occur, the fittest alleles in a population will be selected from the gene pool. Sufficient genetic and phenotypic variation in a population is paramount for this. Over time, "survival of the fittest" alleles leads to changes in the composition of the gene pool in a population and favorable alleles will go to fixation, while disadvantegous alleles will disappear.
...
- textbooks on population genetics (Templeton, 2006; Hartl & Clark, 2007; Nielsen & Slatkin, 2013).
- books on theory and statistics of population genetics (Weir, 1996). 
(Hein, Schierup & Wiuf, 2004; Wakeley, 2009; Nielsen & Slatkin, 2013)
