...
```{r qtl-te, echo=FALSE}
knitr::kable(
  te, caption = 'Markers with an error LOD bigger than 3 under an error probability of 0.0001 indicate potential genotyping errors.',
  booktabs = TRUE
)
```
...
```{r qtl-plot-out, fig.cap = "QTL plot showing LOD scores and QTL positions with EM algorithm and the multiple imputation. The dotted line indicates the genome-wide LOD score threshold for a p < 0.05. Every peak above this threshold is considered a QTL.", fig.asp = 0.5, out.width = '90%', fig.align = 'center'}
