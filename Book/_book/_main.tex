...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/qtl-plot-hyper-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/qtl-plot-out-1} 
